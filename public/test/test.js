...
//QUnit.test('Testing checkguess value', function (assert) {
  //assert.equal(checkGuess(55),/Value must be less than 50/, 'Tested with two relatively small positive numbers');

 // assert.throws(function () { checkGuess([]); }, new Error('Number not not be less than 0'), 'Passing in array correctly raises an Error');
 // });
