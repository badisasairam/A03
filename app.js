...
app.post("/contact", function (req, res) {
    var api_key = '62904df17ff234cb2de97c4e70f683f5-4836d8f5-4314977c';
    var domain = 'sandboxb0cacbbd73cc43faa59813234caa811e.mailgun.org';
    ...
    var data = {
      from: 'Excited user <postmaster@sandboxb0cacbbd73cc43faa59813234caa811e.mailgun.org>', // sender address
      to: 'sairambadisa9@gmail.com', // list of receivers
      subject: 'queries', // Subject line
      text: name,
...
app.get(function (req, res) {
   ...
   app.listen(process.env.PORT || 8081, function () {
    console.log('Numbers Magic started and listening on http://localhost:8081/' )
   })   